...
export class RoomService {
  ...
  private baseUrl = 'http://localhost:8081/api/v1/rooms'; //trocar a porta para onde está o backend (normalmente é a porta 8080, mas no momento a minha está ocupada)
